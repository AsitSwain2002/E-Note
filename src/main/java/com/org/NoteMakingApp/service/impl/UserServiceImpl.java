...
public class UserServiceImpl implements UserService {
	...
	private void sendMail(Users user,String reqUrl) throws Exception {
		...
		String message = "Hi, <b> [[userName]] </b> <br><br>"
		...
		message= message .replace("[[url]]",reqUrl+ "/api/v1/home/verify?uId="+user.getId()+"&vcode="+user.getUserVerification().getVerificationCode());
